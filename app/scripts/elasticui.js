        ...
        var IndexController = (function () {
            ...
            IndexController.prototype.search = function () {
                ...
                this.searchPromise.then(function (body) {
                    _this.$rootScope.searching = false;
...
// Change: only do search on click, not on change as in original 
var elasticui;
(function (elasticui) {
    (function (controllers) {
        var QueryController = (function () {
            ...
            QueryController.prototype.init = function () {
                ...
                // Hack: Instead of watching all changes in search field
                // only trigger search on search button click
...
// Overrides the original searchbox directive by adding a search button
// Hack: You have to manually remove/uncomment same directive in elasticui.js
var elasticui;
(function (elasticui) {
    (function (widgets) {
        (function (directives) {
